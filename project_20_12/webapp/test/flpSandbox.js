		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Router",
									"targetURL": "#syncproject2012-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject2012-display": {
								"semanticObject": "syncproject2012",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project2012",
									"url": sap.ui.require.toUrl("sync/project2012")
								}
							}
						}
					}
