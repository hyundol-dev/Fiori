		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Connection",
									"targetURL": "#syncproject2002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject2002-display": {
								"semanticObject": "syncproject2002",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project2002",
									"url": sap.ui.require.toUrl("sync/project2002")
								}
							}
						}
					}
