		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (20)",
									"targetURL": "#examexprogram20-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram20-display": {
								"semanticObject": "examexprogram20",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram20",
									"url": sap.ui.require.toUrl("exam/exprogram20")
								}
							}
						}
					}
