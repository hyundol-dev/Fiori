		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales_cust",
									"targetURL": "#salesanalysiscustpmteampj2001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesanalysiscustpmteampj2001-display": {
								"semanticObject": "salesanalysiscustpmteampj2001",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesanalysiscustpm.teampj2001",
									"url": sap.ui.require.toUrl("salesanalysiscustpm/teampj2001")
								}
							}
						}
					}
