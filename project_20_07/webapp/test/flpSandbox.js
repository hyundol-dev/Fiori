			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project2007-display": {
								"semanticObject": "project2007",
								"action": "display",
								"description": "20240105 Model",
								"title": "Model",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project2007",
									"url": sap.ui.require.toUrl("project2007")
								}
							}
						}
					}
