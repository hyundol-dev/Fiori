					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Launchpad Image",
									"targetURL": "#project2016-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"project2016-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project2016",
									"url": sap.ui.require.toUrl("project2016")
								}
							}
						}
					}
