		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData CRUD",
									"targetURL": "#odataproject2013-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject2013-display": {
								"semanticObject": "odataproject2013",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project2013",
									"url": sap.ui.require.toUrl("odata/project2013")
								}
							}
						}
					}
